...
// ── RESUME ──────────────────────────────────────────────────
// Drop your PDF into the /public folder, then update the name here.
export const RESUME_FILE = "Om_Patel_Resume.pdf";
...
export const HERO = {
  ...
  tagline:
    "CS student at CSULB ('27) building AI systems, LLM-powered products, and backends that hold up under load.",
  roles: [
...
// ── RESUME — projects section (can differ from PROJECTS above) ──
...
export const SKILLS = [
  ...
  },
  {
    heading: "AI / ML",
    chips: [
      "PyTorch", "RL & Simulation", "RAG", "Embeddings",
      "Prompt Eng.", "Fine-tuning", "OpenCV", "pandas", "NumPy",
    ],
  },
  {
    heading: "BACKEND & INFRA",
    chips: [
      "Node.js", "Flask", "PostgreSQL", "pgvector", "MongoDB",
  ...
  },
  {
    ...
    chips: [
      ...
      "REST APIs", "WebSockets", "Kafka", "Agile",
    ],
  },
];

// ── RESUME — skills summary lines ───────────────────────────
...
export const CONTACT = {
  blurb:
    "I'm open to internships, research collaborations, and interesting engineering problems. The fastest way to reach me is email. I usually reply within a day.",
};
